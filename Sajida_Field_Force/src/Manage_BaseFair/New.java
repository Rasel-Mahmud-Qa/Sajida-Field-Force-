	...
	public static void main(String[] args) throws InterruptedException {
	       ...
	       // start the application
			...
			//Input valid user name and password
					driver.findElement(By.name("xe_username")).sendKeys("super_admin");
	 ...
	 
	       {
	          ...
	          if (ele.getAttribute("innerHTML").contains("Manage Base Fair")) {
	     ...
	     //Forum Page
	     //driver.findElement(By.xpath("/html[1]/body[1]/div[2]/div[1]/div[1]/ul[1]/li[11]/ul[1]/li[1]/a[1]/span[1]")).click();
