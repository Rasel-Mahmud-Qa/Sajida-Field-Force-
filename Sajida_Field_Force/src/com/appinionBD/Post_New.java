...
public class Post_New {
	...
	public static void main(String[] args) throws InterruptedException {
	       ...
	       driver.findElement(By.xpath("/html[1]/body[1]/div[2]/div[1]/div[1]/ul[1]/li[7]/ul[1]/li[2]/a[1]/span[1]")).click();
	       driver.findElement(By.xpath("/html[1]/body[1]/div[2]/div[2]/div[3]/div[1]/a[1]")).click();
	       
	       //driver.findElement(By.id("title")).sendKeys("Create New Forum");
